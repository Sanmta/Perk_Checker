...
class Ui_MainWindow(object):
    def setup_ui(self, MainWindow):
        ...
        self.checkbox_eyes = create_checkbox(self, "Assume eye perks are Deja Vu", 20, 840, 200, 22)
        ...
        self.UI_scale_input.setText(str(resolution_scale))
...
def create_settings_cog(self):
    ...
    self.settings_button.setStyleSheet(""" 
        ...
        """)
    self.settings_button.clicked.connect(open_settings_window(self))
...
def open_settings_window(self):
    ...
    self.settings_window.exec_()  # Show the settings window modally
